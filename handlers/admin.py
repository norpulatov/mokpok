...
from keyboards.inline import back_to_start_keyboard
    ...
    async with AsyncSessionLocal() as session:
        ...
        try:
            forwarded = await message.bot.copy_message(
                ...
                message_id=message.message_id - 1 if message.text != "/skip" else message.message_id - 2  # approximation; better to store message_id of video
            )
